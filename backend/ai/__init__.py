...
from .osm_loader import load_place_graph, load_panabo_graph
...
__all__ = [
    ...
    "load_place_graph",       # OSM download for the active region
    "load_panabo_graph",      # deprecated alias for load_place_graph
