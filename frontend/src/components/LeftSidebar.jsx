...
function LogIncIcon({ className = "btn-icon" }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 -960 960 960"
...
function ReporrtIncIcon({ className = "btn-icon" }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 -960 960 960"
...
export default function LeftSidebar({
  ...
  if (collapsed) {
    return (
      <aside className="sidebar-left collapsed">
        ...
        <div className="sidebar-section">
          <div className="slc-expand-btn-wrap">
            ...
            >
              <FireGeneralIcon className="slc-section-icon slc-section-icon--fire" />
        ...
        <div className="sidebar-section-last">
          <div className="slc-expand-btn-wrap">
            ...
            >
              <PersonnelGeneralIcon className="slc-section-icon slc-section-icon--blue" />
        ...
        <div className="slc-action-btn-wrap">
          ...
          >
            {pickingMode ? (
              ...
              <LogIncIcon className="slc-action-icon" />
            )}
          </button>
          <button
            ...
            disabled={pickingMode}
          >
            <ReporrtIncIcon className="slc-action-icon" />
            {reporterCount > 0 && (
