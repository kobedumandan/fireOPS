...
function validateForm(form) {
  const required = ['station_name', 'station_address', 'station_barangay', 'station_latitude', 'station_longitude', 'station_contact']
  ...
  if (!form.station_latitude || !form.station_longitude) return 'Please pick a location on the map.'
      ...
      <div className="apm-panel lim-panel">
        <div className="apm-header">
          <div>
            ...
            <div className="apm-title">Add New Station</div>
          </div>
          <button className="apm-close" onClick={onClose}>✕</button>
        </div>

        <div className="apm-scroll">
          <form id="asm-add-form" className="apm-body" onSubmit={handleSubmit}>
        ...
        <div className="apm-actions">
          ...
          <button type="submit" form="asm-add-form" className="apm-btn-submit" disabled={saving}>
